...
#####Objekt: #####Metoder: #####Variaber: #####Aktörer:  Månadskort, biljett
...
####Daglogg : 29/10   Vi har formulerat med varandra via Teams vilken kod vi ska skriva. Vi har delat skärm och skrivit all kod på en dator. Vi har sökt upp olika begrepp och metoder för att kunna välja och svara på olika problem vi har stött på.
...
#####Vilka klasser och metoder har vem haft ansvar för? Main, Tickets, Person, Conductor, Travelers, Trainstation
